...
vtune -collect hotspots -result-dir vtune_data $(pwd)/BM3Ddenoising lena.png 25.0 0 ImNoisy.dat ImBasic.dat ImDenoised.dat ImDiff.dat ImBias.dat ImDiffBias.dat 0 dct 1 dct 1 rgb


vtune -report summary -result-dir vtune_data -format html -report-output $(pwd)/summary1.html
